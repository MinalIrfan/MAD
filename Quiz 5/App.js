...
const App = () => {
  ...
  const [profile, setProfile] = useState({ name: 'Fahad Afzal', email: 'fahad@gmail.com', phone: '+923 1455555' });
      ...
      <SafeAreaView style={{ flex: 1 }}>
        {isWelcomeVisible && (
          <Animated.View style={[styles.welcomeContainer, welcomeAnimatedStyle, { backgroundColor: 'rgba(10, 10, 25, 0.95)' }]}>
            <Text style={styles.welcomeText}>Welcome to Fahad's Cosmic Store</Text>
          </Animated.View>
        )}
